...
debug_win_name = "jar#plugins\dist\M32Library.jar#m32plugin.M32Library"
...
for child in root:
    if child.tag == "lib" and (child.attrib['desc'] == debug_name or child.attrib['desc'] == debug_win_name):
