...
class ArrowWire32bitsName implements StringGetter{
	String name = "Arrow Wire (32 bits)";
	
	public ArrowWire32bitsName() {}
...
public class ArrowWire32bits extends InstanceFactory {
    public static ArrowWire32bitsName componentName = new ArrowWire32bitsName();
    ...
    public ArrowWire32bits() {
        super("ArrowWire32bits", new ArrowWire32bitsName());
        setInstancePoker(ArrowWire32bitsPoker.class);
        setInstanceLogger(ArrowWire32bitsLogger.class);
        setAttributes(
    ...
    public static class ArrowWire32bitsPoker extends InstancePoker {
        @Override
    ...
    public static class ArrowWire32bitsLogger extends InstanceLogger {
        @Override
