...
public class RBankWire extends InstanceFactory {
    private InstanceState state;
    public static RBankWireName componentName = new RBankWireName();
    ...
    public RBankWire() {
        super("RBankWire", new RBankWireName());
        setInstancePoker(RBankWirePoker.class);
        setInstanceLogger(RBankWireLogger.class);
        setAttributes(
    ...
    public static class RBankWirePoker extends InstancePoker {
        @Override
    ...
    public static class RBankWireLogger extends InstanceLogger {
        @Override
